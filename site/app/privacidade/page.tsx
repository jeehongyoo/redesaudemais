  ...
  return (
    <section className="section-rythm">
      <div className="container-site measure">
        <h1 data-words className="sec-title font-heading text-3xl font-semibold text-[#162B4D]">Política de Privacidade</h1>
        ...
        <div className="space-y-4 text-sm leading-relaxed text-[#333333]/90">
          ...
          <h2 className="font-heading text-lg font-semibold text-[#162B4D]">Dados de contato</h2>
          ...
          <h2 className="font-heading text-lg font-semibold text-[#162B4D]">Resultados de exames</h2>
          <p>O botão “Resultados de Exames” abre o portal externo resultados.app.br, com política própria.</p>
          <h2 className="font-heading text-lg font-semibold text-[#162B4D]">Cookies</h2>
          <p>Este site não define cookies de rastreamento próprios.</p>
          <h2 className="font-heading text-lg font-semibold text-[#162B4D]">Contato</h2>
